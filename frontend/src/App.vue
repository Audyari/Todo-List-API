  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col font-display">
    ...
    <header class="w-full border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
      <div class="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
        ...
        <button class="flex min-w-[84px] cursor-pointer items-center justify-center rounded-lg h-9 px-4 bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-white text-sm font-bold hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
      ...
      <div class="w-full max-w-md bg-white dark:bg-gray-800 shadow-sm rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="px-8 pb-8">
          <p class="text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <a class="font-semibold text-blue-600 hover:text-blue-500 transition-colors" href="#">Log in</a>
          </p>
        </div>
      </div>
    </main>
